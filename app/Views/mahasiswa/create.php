    ...
    <main class="page-container" style="max-width: 600px;">
        ...
        <div class="modern-card fade-in-up delay-1">
            <div class="modern-card-header"
                style="background: linear-gradient(135deg, var(--primary), var(--bg-gradient-end));">
                <h4><i class="bi bi-person-plus-fill"></i> Form Data Mahasiswa Baru</h4>
            </div>
            ...
            <div class="modern-card-body">
                <form id="formTambah">
                    <div class="form-floating-custom">
                        ...
                        <input type="text" id="nim" class="form-input" placeholder="Contoh: 123456789" required>
                    </div>
                    ...
                    <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                        ...
                        <button type="submit" class="btn-modern btn-primary-modern" style="flex: 2;" id="submitBtn">
                            <span id="btnText">
